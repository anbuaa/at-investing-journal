...
def show_settings(journal):
    ...
    st.markdown("""
    **Multi-User Personal Investment Journal v3.0**
    
    ### ✨ Features:
    - ✅ **Multi-user authentication** - Secure login system with user isolation
    - ✅ **Multi-portfolio support** - Manage separate investment strategies
    - ✅ **Real-time stock price updates** - Powered by Yahoo Finance
    - ✅ **XIRR calculations** - Individual securities, portfolios, and total
    - ✅ **Performance benchmarking** - Compare with NIFTY indices
    - ✅ **Sky blue theme** - Beautiful and professional UI
    ...
    - **Data privacy:** No user can see another user's portfolio data
    
    ### 📊 **Data Sources:**
    - **Stock prices:** Yahoo Finance (yfinance library)
    - **Database:** SQLite (local storage with user separation)
    - **Charts:** Plotly (interactive visualizations)
    
    ### 🚀 **Multi-User Benefits:**
    - Family members can have separate portfolios
    - Team/organization can use single deployment
    - Each user has personalized dashboard
    - Secure data isolation between users
    
    **Note:** This application is for educational and personal use only. Always consult with financial advisors for investment decisions.
    """)
